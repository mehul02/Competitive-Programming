...
1117 C - Magic Ship.cpp GNU C++14 Accepted
///==================================================///
	///
	///  Ir0nic_  ///
    ///  MEHUL BHUTALIA  ///
       ...
       /////////////////////////////////////////////////////////
           ...
           while(l<h)
           {
               ...
               ll xx=(mid/n)*pre[n-1];
                ...
                ll yy=(mid/n)*pre2[n-1];
                if(mid%n!=0)
                {
                    ll v=mid%n-1;
                    yy+=pre2[v];
                }
                ll mdist=abs(x2-xx)+abs(y2-yy);
                //debug2(abs(x2-xx),abs(y2-yy))
                if(mdist<=mid)
                {
                    h=mid;
                }
...
1117 C - Magic Ship.cpp GNU C++14 Wrong answer on test 2
///==================================================///
	///
	///  Ir0nic_  ///
    ///  MEHUL BHUTALIA  ///
