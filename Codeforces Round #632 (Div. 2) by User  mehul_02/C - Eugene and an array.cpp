...
1333 C - Eugene and an array.cpp GNU C++17 Accepted
// clang-format off
///==================================================///
///
///  Ir0nic_  ///
...
int main()
{
	...
	rep(i, n)
	{
		...
		// 	sum[i] = i - mp[cnt] - 1, maxx = max(maxx, mp[cnt] + 1);
		// else
		// 	sum[i] = i - maxx;
		if (mp.find(cnt) != mp.end())
			maxx = max(maxx, mp[cnt] + 1);
		sum[i] = i - maxx;
		mp[cnt] = i;
	}
	ll ans = 0;
...
1333 C - Eugene and an array.cpp GNU C++17 Wrong answer on pretest 5
// clang-format off
///==================================================///
///
///  Ir0nic_  ///
