...
1082 C - Multi-Subject Competition.cpp GNU C++14 Accepted
///==================================================///
	///
	///  Ir0nic_  ///
    ///  MEHUL BHUTALIA  ///
    ...
    ll getMaxArea(vi hist, ll n)
{
    ...
    int main()
    {
       ...
       repp(i,1,n+1)
       {
           ...
           {
               //prvec(ans[i])
               maxx=max(getMaxArea(ans[i],ans[i].size()),maxx);
           }
       }
      pr(maxx)
    }
1082 C - Multi-Subject Competition.cpp GNU C++14 Runtime error on test 10
///==================================================///
	///
	///  Ir0nic_  ///
    ///  MEHUL BHUTALIA  ///
...
1082 C - Multi-Subject Competition.cpp GNU C++14 Wrong answer on test 3
///==================================================///
	///
	///  Ir0nic_  ///
    ///  MEHUL BHUTALIA  ///
