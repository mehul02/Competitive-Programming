...
1182 B - Plus from Picture.cpp GNU C++14 Accepted
///==================================================///
	///
	///  Ir0nic_  ///
    ///  MEHUL BHUTALIA  ///
...
//    debug2(d,e)
    if(d+e-1==c)
    {
        if(arr[a][b-1]=='*'&&arr[a][b+1]=='*'&&arr[a-1][b]=='*'&&arr[a+1][b]=='*')
        return true;
    }
...
1182 B - Plus from Picture.cpp GNU C++14 Wrong answer on pretest 12
///==================================================///
	///
	///  Ir0nic_  ///
    ///  MEHUL BHUTALIA  ///
