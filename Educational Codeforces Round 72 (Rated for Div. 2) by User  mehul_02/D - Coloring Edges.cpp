...
1217 D - Coloring Edges.cpp GNU C++14 Accepted
///==================================================///
	///
	///  Ir0nic_  ///
    ///  MEHUL BHUTALIA  ///
...
int main()
{
   ...
   if(mp.size()==0)
    ...
    rep(i,m)
    {
        if(mp.find(m_p(arr[i].ff,arr[i].ss))!=mp.end())
        cout<<"2 ";
        else
        cout<<"1 ";
    }
...
1217 D - Coloring Edges.cpp GNU C++14 Compilation error
///==================================================///
	///
	///  Ir0nic_  ///
    ///  MEHUL BHUTALIA  ///
...
1217 D - Coloring Edges.cpp GNU C++14 Wrong answer on test 1
///==================================================///
	///
	///  Ir0nic_  ///
    ///  MEHUL BHUTALIA  ///
