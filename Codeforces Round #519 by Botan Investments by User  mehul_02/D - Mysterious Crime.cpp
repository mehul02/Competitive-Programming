...
1043 D - Mysterious Crime.cpp GNU C++14 Accepted
///==================================================///
	///
	///  Ir0nic_  ///
    ///  MEHUL BHUTALIA  ///
    ...
    int main()
    {
        ...
        repp(i,1,n)
        {
            ...
            {
                if(j==0)
                diff=(v[arr[i-1]][j]-v[arr[i]][j]);
                else if((v[arr[i-1]][j]-v[arr[i]][j])!=-1)
                {
                    f=1;
                    break;
                }
...
1043 D - Mysterious Crime.cpp GNU C++14 Wrong answer on test 1
///==================================================///
	///
	///  Ir0nic_  ///
    ///  MEHUL BHUTALIA  ///
    ...
    int main()
    {
        ...
        repp(i,1,n)
        {
            ...
            rep(j,m)
            {
                if(j==0)
                diff=(v[arr[i-1]][j]-v[arr[i]][j]);
                else if((v[arr[i-1]][j]-v[arr[i]][j])!=diff)
                {
                    f=1;
                    break;
                }
